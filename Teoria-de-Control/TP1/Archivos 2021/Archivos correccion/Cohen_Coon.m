...
%Graficas
subplot(2,1,1), plot(t,z), title('Variable modificada'),grid on
subplot(2,1,2), plot(t,y), title('Respuesta de la variable en estudio'),grid on
...
r=tg*t+aux2;
figure
plot(t,y,'b',t,r,'r'), legend('Derivada de la respuesta','Recta tangente al punto de inflexion'),grid on
